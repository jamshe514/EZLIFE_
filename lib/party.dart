...
import 'package:demo_project/sduledparty.dart';
...
import 'package:demo_project/view/users/booking_slot.dart';
...
class bookingpageparty extends StatefulWidget {
  const bookingpageparty({super.key});

  @override
  State<bookingpageparty> createState() => _bookingpageState();
}

class _bookingpageState extends State<bookingpageparty> {
                      ...
                      children: [
                        Container(
                            ...
                            decoration: BoxDecoration(
                                image: DecorationImage(
                                  image: AssetImage(
                                      'assets/images (21).jpeg'), // Replace 'assets/image.jpg' with your image path
                                  fit: BoxFit
