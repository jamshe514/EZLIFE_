...
import 'package:demo_project/sduledturaf.dart';
...
class bookingpagetruf extends StatefulWidget {
  const bookingpagetruf({super.key});

  @override
  State<bookingpagetruf> createState() => _bookingpageState();
}

class _bookingpageState extends State<bookingpagetruf> {
                      ...
                      children: [
                        Container(
                            ...
                            decoration: BoxDecoration(
                                image: DecorationImage(
                                  image: AssetImage(
                                      'assets/truf.jpeg'), // Replace 'assets/image.jpg' with your image path
                                  fit: BoxFit
