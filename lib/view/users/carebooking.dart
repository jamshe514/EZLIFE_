...
import 'package:demo_project/caresheduled.dart';
...
class bookingpagecare extends StatefulWidget {
  const bookingpagecare({super.key});

  @override
  State<bookingpagecare> createState() => _bookingpageState();
}

class _bookingpageState extends State<bookingpagecare> {
                      ...
                      children: [
                        Container(
                            ...
                            decoration: BoxDecoration(
                                image: DecorationImage(
                                  image: AssetImage(
                                      'assets/care.jpg'), // Replace 'assets/image.jpg' with your image path
                                  fit: BoxFit
